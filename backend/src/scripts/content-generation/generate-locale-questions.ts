...
async function loadLocaleConfig(locale: string): Promise<LoadedConfig> {
  const supportedLocales: Record<string, () => Promise<{ default?: LocaleConfig; [key: string]: unknown }>> = {
    ...
    'biloxi-ms': () => import('./locale-configs/biloxi-ms.js') as Promise<{ biloxiMsConfig: LocaleConfig }>,
      ...
      'springfield-mo': () => import('./locale-configs/springfield-mo.js') as Promise<{ springfieldMoConfig: LocaleConfig }>,
      'st-louis-mo': () => import('./locale-configs/st-louis-mo.js') as Promise<{ stLouisMoConfig: LocaleConfig }>,
      'missouri': () => import('./locale-configs/missouri.js') as Promise<{ missouriConfig: LocaleConfig }>,
      'arizona': () => import('./locale-configs/arizona.js') as Promise<{ arizonaConfig: LocaleConfig }>,
      'tucson-az': () => import('./locale-configs/tucson-az.js') as Promise<{ tucsonAzConfig: LocaleConfig }>,
      'phoenix-az': () => import('./locale-configs/phoenix-az.js') as Promise<{ phoenixAzConfig: LocaleConfig }>,
      ...
      'bainbridge-island-wa': () => import('./locale-configs/bainbridge-island-wa.js') as Promise<{ bainbridgeIslandWaConfig: LocaleConfig }>,
